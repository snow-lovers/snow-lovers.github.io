this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  var Qa = "IN_PROGRESS",
      Za = "WIN",
      es = "FAIL",
      as = ["Is your name Sonia by any chance ?", "Nice", "Not too shabby"],
      ss = function(e) {
          n(t, e);
          var a = h(t);
            ...
            value: function() {
              ...
              value: function() {
                  ...
                  this.$game.addEventListener("game-key-press", (function(a) {
                      ...
                      switch (t) {
                          case "hard-mode":
                              return void(r ? e.addToast("The hard mode can only be activated at the start of the game", 1500, !0) : (e.hardMode = o, ja({
                                  hardMode: o
                              })))
                      }
