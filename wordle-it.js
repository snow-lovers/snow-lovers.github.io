this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark mode</div>\n  </div>\n        <div class="control">\n  <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n <div class="setting">\n        <div class="text">\n          <div class="title">Snow mode</div>\n  <div class="description">Currently always on bcs I forgot to activate this button)</div>      </div>\n        <div class="control">\n       <game-switch ></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n     </section>\n  </div>\n  <div id="footnote">\n    <div hidden id="puzzle-number"></div>\n    <div id="hash"></div>\n  <div>\n';
    var _a = function (e) {
        n(t, e);
        var a = h(t);
    ...
    function Pa(e) {
        var a, s = Na(e);
        //      return a = s % Aa.length, Aa[a] // Generates a new word with the index and 82 times. To avoid repetition, to reuse for me
        return "★★☆☆☆"  // ☆ ★
    }
    ...
    var Qa = "IN_PROGRESS",
        ...
        ss = function (e) {
            ...
            return o(t, [{
                key: "evaluateRow",
                value: function () {
                    if (5 === this.tileIndex && !(this.rowIndex >= 3)) {
                        var e, a = this.$board.querySelectorAll("game-row")[this.rowIndex],
                            s = this.boardState[this.rowIndex];

                        var n = function (word, solution) {
                            for (var s = Array(solution.length).fill(Ca), t = Array(solution.length).fill(!0), o = Array(solution.length).fill(!0), r = 0; r < word.length; r++)
                                word[r] === solution[r] && o[r] && (s[r] = Ia, t[r] = !1, o[r] = !1);
                ...
                key: "removeLetters",
                value: function () {
                    while (this.gameStatus === Qa && this.canInput && !(this.tileIndex <= 0)) {
                ...
                value: function () {
                    if (this.gameStatus === Qa && this.canInput) {
                        if (5 !== this.tileIndex) return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("No rating");
                        this.evaluateRow()
                    }
                }
            }, {
                ...
                value: function () {
                    var e = this.shadowRoot.querySelector("#board-container"),
                        a = Math.min(Math.floor(e.clientHeight * (5 / 3)), 350),
                        s = 3 * Math.floor(a / 5);
                ...
                value: function () {
                    ...
                    this.gameStatus === Za && this.rowIndex <= 3 && a.setAttribute("highlight-guess", this.rowIndex), a.gameApp = this, e.appendChild(a), e.setAttribute("open", "")
                }
            }, {
                key: "showHelpModal",
                value: function () {
                ...
                value: function () {
                    var e = this;
                    this.shadowRoot.appendChild(Ka.content.cloneNode(!0)), this.$game = this.shadowRoot.querySelector("#game"), this.$board = this.shadowRoot.querySelector("#board"), this.$review = this.shadowRoot.querySelector('#review'), this.$keyboard = this.shadowRoot.querySelector("game-keyboard"), this.sizeBoard(), this.lastPlayedTs || setTimeout((function () {
                    ...
                    username.textContent = "Daily reviewer \r\n\r\n";
                    ...
                    this.$game.addEventListener("game-key-press", (function (a) {
                        var s = a.detail.key;
                        if ("←" === s || "Backspace" === s) e.removeLetters()
                        if ("↵" === s || "Enter" === s) e.submitGuess()
                        if (s === "1") { e.removeLetters(), e.addLetter("★"), e.addLetter("☆"), e.addLetter("☆"), e.addLetter("☆"), e.addLetter("☆") }
                        if (s === "2") { e.removeLetters(), e.addLetter("★"), e.addLetter("★"), e.addLetter("☆"), e.addLetter("☆"), e.addLetter("☆") }
                        if (s === "3") { e.removeLetters(), e.addLetter("★"), e.addLetter("★"), e.addLetter("★"), e.addLetter("☆"), e.addLetter("☆") }
                        if (s === "4") { e.removeLetters(), e.addLetter("★"), e.addLetter("★"), e.addLetter("★"), e.addLetter("★"), e.addLetter("☆") }
                        if (s === "5") { e.removeLetters(), e.addLetter("★"), e.addLetter("★"), e.addLetter("★"), e.addLetter("★"), e.addLetter("★") }
                    })), this.$game.addEventListener("game-last-tile-revealed-in-row", (function (a) {
                        e.$keyboard.letterEvaluations = e.letterEvaluations, e.rowIndex < 3 && (e.canInput = !0);
                        var s = e.$board.querySelectorAll("game-row")[e.rowIndex - 1];
                        (a.path || a.composedPath && a.composedPath()).includes(s) && ([Za, es].includes(e.gameStatus) && (e.restoringFromLocalStorage ? e.showStatsModal() : (e.gameStatus === Za && (s.setAttribute("win", ""), e.addToast(as[e.rowIndex - 1], 2e3)), e.gameStatus === es && e.addToast(e.solution, 1 / 0), setTimeout((function () {
                            e.showStatsModal()
                    ...
                    for (var a = this.shadowRoot.getElementById("statistics"), s = this.shadowRoot.getElementById("guess-distribution"), t = Math.max.apply(Math, g(Object.values(this.stats.guesses))), o = 1; o < Object.keys(this.stats.guesses).length; o++) {
                        ...
                        us(function (e) {
                            var a = e.evaluations,
                                ...
                                i = JSON.parse(window.localStorage.getItem(S)),
                                l = "S-review n°".concat(s);
                            l += " ".concat(r ? t : "X", "/").concat(3), o && (l += "*");
                            var d = "";
                            ...
                            dayOffset: e.gameApp.dayOffset - 82,
                            ...
                            e.gameApp.addToast("Error copying results", 2e3, !0)
                        }))
                    }))
                }
            }]), t
